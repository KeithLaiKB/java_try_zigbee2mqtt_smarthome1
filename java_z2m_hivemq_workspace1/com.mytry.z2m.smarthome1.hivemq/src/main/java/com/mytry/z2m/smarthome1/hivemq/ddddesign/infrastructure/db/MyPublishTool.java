...
public class MyPublishTool {
	 ...
	 * @return
	 */
	public static int myPulibshWithConnectionPool(String brokerIpAddress, int brokerPort, String clientId, ArrayList<String>  aryList_topicUrlToPublish, ArrayList<String> aryList_str_json, long timeGapEachDevice) {
        //
