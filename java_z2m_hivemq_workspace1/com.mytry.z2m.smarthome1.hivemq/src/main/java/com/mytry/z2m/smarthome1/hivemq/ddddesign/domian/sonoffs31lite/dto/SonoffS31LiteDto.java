package com.mytry.z2m.smarthome1.hivemq.ddddesign.domian.sonoffs31lite.dto;
 ...
 *
 */
public class SonoffS31LiteDto extends AbstractSmartDeivceDto {
	private String 	state = null;
	private Integer linkquality = null;
	
	public SonoffS31LiteDto() {
		
	}
	public SonoffS31LiteDto(String state, Integer linkquality) {
		super();
		this.state = state;
	...
	public String toString() {
		return "SonoffS31LiteDto [state=" + state + ", linkquality=" + linkquality + "]";
	}
