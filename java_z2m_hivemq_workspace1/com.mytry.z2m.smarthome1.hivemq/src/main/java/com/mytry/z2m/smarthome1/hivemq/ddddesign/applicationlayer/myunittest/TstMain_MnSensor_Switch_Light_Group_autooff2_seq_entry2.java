...
import com.mytry.z2m.smarthome1.hivemq.ddddesign.applicationlayer.SonoffS31LiteSubscriber_ForKeepRunning;
 ...
 *
 */
public class TstMain_MnSensor_Switch_Light_Group_autooff2_seq_entry2 {
	...
	public static void main(String[] args){
        ...
        */
        ...
        //
        //
        Runnable rnb_sonoffS31Lite_subscriber1 =new SonoffS31LiteSubscriber_ForKeepRunning();
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setIeeeAddress("0x00124b00250c256f");
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setTopicUrl("zigbee2mqtt/0x00124b00250c256f");
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setTopicUrl_get("zigbee2mqtt/0x00124b00250c256f/get");
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setTopicUrl_set("zigbee2mqtt/0x00124b00250c256f/set");
        //
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setMyThreadRunflag(1);
        //
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setBrokerIpAddress1("192.168.50.179");
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setBrokerPort1(1883);
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setClientId1("IamSonoffS31Lite1Client1");
        //
        //
        
        //
        Thread trd_rnb_tryAutoOff1 =new Thread(rnb_sonoffS31Lite_subscriber1);
        trd_rnb_tryAutoOff1.start();
        //
        //
        //
        ...
        */
        		...
        		if(publish.getTopic().toString().equals(topicSensorSub1)==true) {
            		...
            		if(philipsHueOutdoorMotionSensorDoTmp == null) {
            			...
            			if(repoOpreationResultTmp == 1) {
            				System.out.println("myAdd philips Outdoor Montion Sensor successfully");
            			}
            		}
            			...
            			System.out.println("myUpdate philips Outdoor Montion Sensor successfully");
            		}
        ...
        String toEnd = in.nextLine();
        //
        // 暂停结束掉 那个进程
        ((SonoffS31LiteSubscriber_ForKeepRunning)rnb_sonoffS31Lite_subscriber1).setMyThreadRunflag(0);
        //
        client1.disconnect();
        //client1.
